...
incrementale nel corso del tempo e quando viene definita baseline.
Per tutti questi motivi, la qualità viene definita da un insieme di processi che cerchino di definire
metriche di misurazione di efficacia ed efficienza (misure quantitative che serviranno da valutazione 
nel corso di realizzazione del progetto didattico)
\paragraph{}
