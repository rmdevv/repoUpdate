...
{Valutazione di eventuali modifiche alle Norme di progetto per migliorare il nostro \textit{Way of Working}: \begin{itemize}
        \item Aggiornare le \textit{Branch Protection Rules};
        ...
        \item Templetizzare la creazione delle issue nell'ITS fornito da \textit{GitHub}.
    \end{itemize}},
{In seguito alle valutazioni delle Candidature del 2023-11-06, si percepisce il bisogno di:
    ...
    \item Aggiornare l'approcio al versionamento della documentazione;
...
{Le versioni presenteranno il formato vX.Y.Z e non potrà esistere la versione v0.0.0;},
{Introdurre la versione nel nome dei documenti versionati;},
